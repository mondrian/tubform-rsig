...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	 ...
	 */
	,searchTipText:'Digite um texto e pressione Enter'
	 ...
	 */
	,minCharsTipText:'Digite no mínimo {0} caracteres'
	...
	,onRender:function() {
		...
		this.field = new Ext.form.TwinTriggerField({
			...
			,onTrigger1Click:this.minChars ? this.onTriggerClear.createDelegate(this) : Ext.emptyFn
