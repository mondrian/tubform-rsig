...
describe "/itens_nota_fiscal/edit.html.erb" do
  ...
  it "renders the edit item_nota_fiscal form" do
    render
    
    response.should have_tag("form[action=#{item_nota_fiscal_path(@item_nota_fiscal)}][method=post]") do
