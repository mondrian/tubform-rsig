...
describe "/produto_kits/edit.html.erb" do
  ...
  it "renders the edit produto_kit form" do
    render
    
    response.should have_tag("form[action=#{produto_kit_path(@produto_kit)}][method=post]") do
